...
ES_train_file = open("/Users/chuaqibao/Downloads/Project_Submission 2/ES/train", "r", encoding='UTF-8')
RU_train_file = open("/Users/chuaqibao/Downloads/Project_Submission 2/RU/train", "r", encoding='UTF-8')
...
ES_new_test = open('/Users/chuaqibao/Downloads/Project_Submission 2/ES/dev.in')
RU_new_test = open("/Users/chuaqibao/Downloads/Project_Submission 2/RU/dev.in")
...
with open ("/Users/chuaqibao/Downloads/Project_Submission 2/ES/dev.p4.out", "w") as file:
    for item in ES_new_output:
        file.write(item)
        file.write ('\n')

with open ("/Users/chuaqibao/Downloads/Project_Submission 2/RU/dev.p4.out", "w") as file:
