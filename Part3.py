...
train_file = open("/Users/chuaqibao/Downloads/Project_Submission/ES/train", "r", encoding='UTF-8')
ViterbiSentence = get_sentence("/Users/chuaqibao/Downloads/Project_Submission/ES/dev.in") 

test_file = open("/Users/chuaqibao/Downloads/Project_Submission/ES/dev.in", "r", encoding='UTF-8')
...
train_transitionES = transition_parameter("/Users/chuaqibao/Downloads/Project_Submission/ES/train")[1]
train_transitionRU = transition_parameter("/Users/chuaqibao/Downloads/Project_Submission/RU/train")[1]

with open ("/Users/chuaqibao/Downloads/Project_Submission/ES/dev.p3.out", "w" , encoding="UTF-8") as file :       #change here for ES/RU , RU/ES
    for sentence in ViterbiSentence:
        ListPath = (modifiedViterbi(5, train_labels, max_em, train_transitionES, sentence))[1]
